...
GameWorld::GameWorld(const int height, const int width, int& org_size, int& number_of_food, int& number_of_antibiotic) : grid(height, width, grid_size), height(height), width(width) , org_size(org_size), number_of_food(number_of_food), number_of_antibiotic(number_of_antibiotic) {
}

template <typename T>
int GameWorld::sum_of_vector(const T & v) const {
   int sum = 0;
...
void GameWorld::spawn_organisms(int amount, int energy) {
...
void GameWorld::spawn_random_food(int amount_of_food) {
...
void GameWorld::create_antibiotic_block(int antibiotic_energy, int click_x, int click_y, int amount_of_lines) {
...
void GameWorld::spawn_antibiotics(int amount_of_lines, int amount_of_antibiotics, int antibiotic_energy) {
